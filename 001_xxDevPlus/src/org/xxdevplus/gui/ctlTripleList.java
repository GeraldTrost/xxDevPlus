...
import org.xxdevplus.gui.ctlCanvas;
import org.xxdevplus.gui.ctlString;
import org.xxdevplus.utl.ctx;
import org.xxdevplus.utl.utl;


public class ctlTripleList extends ctlCanvas
{
 ...
 public    Pile<Pile<JComponent>>        oTrans             = new Pile<Pile<JComponent>>(); //should be a Pack<Pile<ctlArrowTerminal>>
 ...
 */
 ...
 public ctlTripleList TableDef() { return tableDef; } public void  TableDef (ctlTripleList value)  { tableDef = value; }

 public ctlTripleList() { try {setSize(200, 60); initComponents(); lTmpl.setVisible(false); mTmpl.setVisible(false); rTmpl.setVisible(false); ddHandle.setVisible(true); ddHandle.setText("ctlTripleList"); OnResize();} catch (Exception ex) {}}

 public ctlTripleList(ctx cx, String editMode) throws Exception
 {
  super(cx);
...
@SuppressWarnings("unchecked")
 ...
 private void initComponents() {
  ...
  btnClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/getr/flexstruc/closebuttonBig.PNG"))); // NOI18N
...
private void mTextMenuMouseClicked(java.awt.event.MouseEvent evt) {
 try { mTextMenu_Click(evt.getSource()); } catch (Exception ex) { Logger.getLogger(ctlTripleList.class.getName()).log(Level.SEVERE, null, ex); }
}

private void rTextMenuMouseClicked(java.awt.event.MouseEvent evt) {
 try { rTextMenu_Click(evt.getSource()); } catch (Exception ex) { Logger.getLogger(ctlTripleList.class.getName()).log(Level.SEVERE, null, ex); }
}
...
private void lTextMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lTextMenuMouseClicked
 try { lTextMenu_Click(evt.getSource()); } catch (Exception ex) { Logger.getLogger(ctlTripleList.class.getName()).log(Level.SEVERE, null, ex); }
...
@Override public void mouseDragged       (MouseEvent       e)
{
 ...
 {
  Logger.getLogger(ctlTripleList.class.getName()).log(Level.SEVERE, null, ex);
 }
}
