...
package org.xxdevplus.chain;
 ...
 class Restrict
 {
  ...
  public  int        len      = 0;
  public  int        ePos     = 0;
  public  boolean    sWide    = false;  //skip empty blocks before sPos if applicable
  public  boolean    eWide    = false;  //skip empty blocks after ePos if applicable

  //private Chain      _source  = null;
  ...
  public Restrict(boolean upward, Chain source, int pattern, int sPosVal, int LenVal, int ePosVal)
  {
   this.upward = upward;
   fullLen = source.len();
   sWide = (pattern >= 10000);
