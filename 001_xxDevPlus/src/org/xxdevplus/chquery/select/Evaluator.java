package org.xxdevplus.chquery.select;

import org.xxdevplus.chquery.helper.Validate;
import org.xxdevplus.chquery.nodes.Comment;
import org.xxdevplus.chquery.nodes.Document;
import org.xxdevplus.chquery.nodes.DocumentType;
import org.xxdevplus.chquery.nodes.Element;
import org.xxdevplus.chquery.nodes.Node;
import org.xxdevplus.chquery.nodes.PseudoTextElement;
import org.xxdevplus.chquery.nodes.TextNode;
import org.xxdevplus.chquery.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static org.xxdevplus.chquery.internal.Normalizer.lowerCase;
import static org.xxdevplus.chquery.internal.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.xxdevplus.chquery.nodes.Attribute> values = element.attributes().asList();
            for (org.xxdevplus.chquery.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    org.xxdevplus.chquery.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
